          ...
          <div className="flex flex-1 w-full items-center justify-between">
            <div className="flex flex-col items-start max-w-full">
              <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/events-list" color="inherit">
              ...
              <div className="flex items-center max-w-full">
                <FuseAnimate animation="transition.expandIn" delay={300}>
                  <Avatar src={avatarNameToPathConverter(eventDetail.author.photoURL)} className="mx-10 my-5" alt={eventDetail.author.displayName} />
                </FuseAnimate>
                <div className="flex flex-col min-w-0">
                  ...
                  <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography variant="caption">{moment(eventDetail.updatedAt).format('LL dddd')}</Typography>
                  </FuseAnimate>
                </div>
              </div>
            </div>
          ...
          <div className="flex w-full h-full justify-center items-center">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <div className="flex flex-col max-w-2xl py-16 px-32 justify-center items-start">
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                  <Typography variant="h1" className="text-24 md:text-32 sm:text-40 whitespace-pre-line py-32">
                    {eventDetail.title}
                  </Typography>
                </FuseAnimate>
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                ...
                <div className="w-full flex flex-col md:flex-row justify-around items-center">
                  ...
                  <div className="w-full sm:w-400 h-200 sm:h-320 pt-10 sm:px-4 sm:py-0">
                    <div className={clsx(classes.board, "flex flex-col items-center justify-end w-full h-full rounded pt-24 rounded-lg shadow-md hover:shadow-lg")} style={{ backgroundImage: `url(${imageNameToPathConverter(eventDetail.speaker.photoURL)})` }}>
                      <div className={clsx(classes.boardInfoWrapper, "flex flex-col justify-start items-center rounded-b-lg w-full pb-8 px-12")}>
                        <Typography className="text-24 font-700">
                          {eventDetail.speaker.displayName}
                        </Typography>
                        <Typography className="text-16 font-500 text-gray-300 text-center">{eventDetail.speaker.title}</Typography>
                      </div>
                    </div>
                  </div>
                  {/* Location */}
                  <div className="w-full sm:w-400 h-200 sm:h-320 pt-10 sm:px-4 sm:py-0">
                    <div className={clsx(classes.board, "flex flex-col items-center justify-end w-full h-full rounded rounded-lg shadow-md hover:shadow-lg bg-white")}>
                      <YSMap width="100%" />
                    </div>
                  </div>
                </div>
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        <Typography className="flex items-center font-semibold">
                          {moment(eventDetail.startDateTime).format('MM/DD (dddd) HH:mm a')} - {moment(eventDetail.endDateTime).format('MM/DD (dddd) HH:mm a')}
                        </Typography>
                      </td>
                    </tr>
                    <tr>
