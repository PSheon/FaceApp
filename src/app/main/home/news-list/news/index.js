          ...
          <div className="flex flex-1 w-full items-center justify-between">
            <div className="flex flex-col items-start max-w-full">
              <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/news-list" color="inherit">
              ...
              <div className="flex items-center max-w-full">
                <FuseAnimate animation="transition.expandIn" delay={300}>
                  <Avatar src={avatarNameToPathConverter(newsDetail.author.photoURL)} className="mx-10 my-5" alt={newsDetail.author.displayName} />
                </FuseAnimate>
              ...
              <div className="flex flex-col max-w-2xl py-16 px-32 justify-center items-start">
                ...
                <div className="flex justify-center items-center pb-32">
                  {newsDetail.tags.map((tag, tagIndex) => (
                    <div className="bg-yellow text-20 text-gray-700 px-2 rounded-full uppercase font-semibold tracking-wide px-12 mr-12" key={tagIndex}>
                      {tag}
                    </div>
                  ))}
                </div>
