...
const data = [
	{
		'id': '1',
		'coverImageUrl': 'https://ys.nat.gov.tw/uploads/space/6ea3c151-df19-8ca2-2490-b23533c0b49b.jpg',
		'title': '開放空間',
	...
	{
		'id': '2',
		'coverImageUrl': 'https://ys.nat.gov.tw/uploads/space/a60cbb48-b95c-3342-d0ea-9e97bf2ac9c0.jpg',
		'title': '圖資中心',
	...
	{
		'id': '3',
		'coverImageUrl': 'https://ys.nat.gov.tw/uploads/space/fb8c2bae-e8fc-e14a-7fcd-1781eef89d20.jpg',
		'title': '亮點工作室',
	...
	{
		'id': '4',
		'coverImageUrl': 'https://ys.nat.gov.tw/uploads/space/3227acae-a312-53cc-6bed-73d1b991c2dc.jpg',
		'title': '團體施測室',
	...
	{
		'id': '5',
		'coverImageUrl': 'https://ys.nat.gov.tw/uploads/space/9a53a7ce-8a9c-8624-b6e4-2c5621b34c3a.jpg',
		'title': '履歷製作室',
	...
	{
		'id': '6',
		'coverImageUrl': 'https://ys.nat.gov.tw/uploads/space/aa6796d7-daac-f4fa-e5b4-72dd69332b80.jpg',
		'title': '商務空間',
	...
	{
		'id': '7',
		'coverImageUrl': 'https://ys.nat.gov.tw/uploads/space/d2d6b911-adca-6091-fffb-a863c699bf21.jpg',
		'title': '團體諮詢室',
...
function SpacePage() {
	...
	const renderBorrowButton = useCallback((space) => {
		if (space.borrowLink) {
			if (USER.role.length === 0) {
				...
				return (
					<Link role="button" to={`/ys-space/borrow/${space.borrowLink}`}>
						<Button
							variant="contained"
							color="primary"
							className="w-full rounded-full"
	...
	return (
		<div className="w-full flex flex-col flex-auto">
			...
			<div className={clsx(classes.header, "flex flex-col flex-shrink-0 items-center justify-center text-center p-16 sm:p-24 h-400 sm:h-360")}>
				...
				<FuseAnimate duration={400} delay={600}>
					<Typography variant="subtitle1" color="inherit" className="opacity-75 mt-8 sm:mt-16 mx-auto max-w-512 whitespace-pre-line">
						當您走出電梯，就會看到Youth Salon明亮舒適的「公共空間」，除了公共空間的設備外，您也可以向服務台工作人員詢問，借用室內特別規劃的各個空間喔！
						</Typography>
				</FuseAnimate>
			</div>
			...
			<div className="flex flex-col flex-1 flex-shrink-0 max-w-xl w-full mx-auto px-16 sm:px-24 py-24 sm:py-32">
				...
				>
					<img className="object-cover object-center w-full" src="https://ys.nat.gov.tw/img/about-space2.png" alt="YS 室內配置圖" />
					{useMemo(() => {
						return data.map((space) => (
							...
							>
								...
								<ExpansionPanelDetails className="flex flex-col">
									<img src={space.coverImageUrl} alt={space.title} className="object-cover object-center w-full md:max-w-400 rounded-12 self-center mb-12 shadow-lg" />
									<Typography className="text-20 whitespace-pre-line">{space.description}</Typography>
									<List
										component="nav"
