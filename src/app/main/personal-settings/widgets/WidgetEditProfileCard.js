  ...
  useEffect(() => {
    if (!form) {
      ...
      setForm({
        ...
        jobTitle: jobTitle || '',
        firstYearOfCareer:
          moment(firstYearOfCareer).format('YYYY/MM') ||
    ...
    if (isLoading) {
      return (
        <span className="flex justify-center">
          更新資料中 <LoadingSpinner width="2em" height="2em" />
        </span>
      );
    } else if (!inputFilled) {
      return '請完成所有欄位';
            ...
            <div className="p-16 sm:p-24 max-w-2xl">
              ...
              <div className="py-32">
                ...
                <CssTextField
                  ...
                  helperText={
                    !/^\(0[0-9]\)\s[0-9]{4}-[0-9]{4}$/.test(form.phone)
                      ? '電話格式錯誤 e.g. (09) 1234-5678'
                      : ''
                  }
                  label="手機"
                  id="phone"
              ...
              <div className="py-32">
                ...
                <FormControl component="fieldset" className="py-12">
                  ...
                  <RadioGroup
                    aria-label="haveParticipated"
                    id="haveParticipated"
                    name="haveParticipated"
                    value={form.haveParticipated}
                    onChange={handleChange}
                    row
                  >
                    <FormControlLabel
              ...
              <div className="pt-32 w-full flex justify-around">
                ...
                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                  ...
                  >
                    ...
                    {renderButtonText({
                      isLoading,
                      inputFilled: userDetailChecker(form)
                    })}
                  </Fab>
                </FuseAnimate>
              </div>
