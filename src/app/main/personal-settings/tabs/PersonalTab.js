...
function PersonalTab(props) {
  ...
  useEffect(() => {
    if (!USER_PROFILE.verified) {
      history.push({
        pathname: `/mail-confirm/${UserData.email}`
      });
    }
  }, [USER_PROFILE.verified, UserData.email]);
        ...
        {isEditMode ? (
          ...
          >
            {!userDetailChecker(UserData) && (
              <div
                className="bg-transparent text-center pb-16 lg:px-4"
                onClick={handledToggleMode}
              >
                <div
                  className="px-12 py-4 bg-orange items-center text-white leading-none rounded-full inline-flex w-lg cursor-pointer"
                  role="alert"
                >
                  <span className="flex rounded-full bg-orange-darker uppercase px-8 py-1 text-xs font-bold mr-3">
                    GO
                  </span>
                  ...
                  <svg
                    className="fill-current opacity-75 h-24 w-24"
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap">
              ...
              <div
                className={clsx(
                  ...
                  'w-full md:w-2/5 sm:w-1/2 sm:px-4 mb-16'
                )}
              >
              ...
              <div
                className={clsx(
                  classes.widgetWrapper,
                  'w-full md:w-3/5 sm:w-1/2 sm:px-4 mb-16'
                )}
              >
              ...
              <div
                className={clsx(
                  classes.widgetWrapper,
                  'w-full md:w-3/5 sm:w-2/3 sm:px-4 mb-16'
                )}
              >
              ...
              <div
                className={clsx(
                  classes.widgetWrapper,
                  'w-full md:w-2/5 sm:w-1/3 sm:px-4 mb-16'
                )}
              >
