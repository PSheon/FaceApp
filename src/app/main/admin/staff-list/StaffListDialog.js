...
import { TextField, Button, Dialog, DialogActions, DialogContent, Icon, IconButton, MenuItem, Typography, Toolbar, AppBar, Avatar } from '@material-ui/core';
...
function StaffListDialog(props) {
	...
	const staffInfoDialog = useSelector(({ staffList }) => staffList.staffInfoDialog);
	...
	function handleToggleActivation() {
		...
		dispatch(Actions.toggleStaffActivation({ staffId: id, email, active: !active }));
		closeComposeDialog();
	}
		...
		>
			...
			<AppBar position="static" elevation={1}>
				...
				<div className="flex flex-col items-center justify-center pb-24">
					<Avatar className="w-96 h-96" alt="staff avatar" src={form.photoURL} />
