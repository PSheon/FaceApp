...
import WidgetRunnersList from './widgets/WidgetRunnersList';
...
function AdminDashboardPage(props) {
	...
	const widgets = useSelector(({ AdminDashboardPage }) => AdminDashboardPage.widgets);
	const projects = useSelector(({ AdminDashboardPage }) => AdminDashboardPage.projects);
	...
	useEffect(() => {
		...
		dispatch(Actions.syncProcessRunners());
	}, [dispatch]);
...
export default withReducer('AdminDashboardPage', reducer)(AdminDashboardPage);
