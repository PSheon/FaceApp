...
export const SYNC_PROCESS_RUNNERS_LIST = '[PROCESS] SYNC PROCESS RUNNERS LIST';
export const ADD_PROCESS_RUNNER = '[PROCESS] ADD RUNNER';


// TODO Fix here
export function syncProcessRunners() {
	return dispatch => {
		eventBusService.getProcessRunners()
			.then(runners => {
				return dispatch({
					type: SYNC_PROCESS_RUNNERS_LIST,
					payload: runners,
				})
			})
	}
