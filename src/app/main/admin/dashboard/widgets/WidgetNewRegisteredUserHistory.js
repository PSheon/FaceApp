...
function WidgetNewRegisteredUserHistory(props) {
	...
	const REGISTERED_USER_INFOS = useSelector(({ adminDashboard }) => adminDashboard.newRegisteredUser)
	...
	}, [REGISTERED_USER_INFOS, unVerifiedRegisteredUserInfos, verifiedRegisteredUserInfos]);
				...
				<div className="container relative p-16 sm:p-24 flex flex-row justify-between items-center">
					...
					<FuseAnimate delay={100}>
						<div className="flex-col">
							...
							<Typography className="h5" color="textSecondary">每月人數變化</Typography>
						</div>
					</FuseAnimate>
									...
									datasets: [
										{
											...
											backgroundColor: theme.palette.secondary.opacity,
										...
										},
										{
											...
											pointBackgroundColor: theme.palette.tertiary.dark,
										...
										},
										{
											...
											backgroundColor: theme.palette.quaternary.opacity,
											pointBackgroundColor: theme.palette.quaternary.dark,
										...
										},
										{
											...
											backgroundColor: theme.palette.quinary.opacity,
											pointBackgroundColor: theme.palette.quinary.dark,
