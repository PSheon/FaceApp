		...
		<div className="flex flex-col justify-between h-full p-4 sm:p-12">
			<div className="toolbar flex align-center justify-end">
				<FuseAnimate animation="transition.expandIn" delay={200}>
					<Tooltip title="複製圖片網址" TransitionComponent={Fade} TransitionProps={{ timeout: 600 }} placement="bottom" onClick={handleCopyImageLink}>
			...
			<div className="p-12">
				<FuseAnimate delay={200}>
					<Typography variant="subtitle1" className="mb-8">{selectedItem.imageName}</Typography>
				</FuseAnimate>
			</div>
		</div>
	);
