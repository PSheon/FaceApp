          ...
          <div className="flex flex-1 w-full items-center justify-between">
            <div className="flex flex-col items-start max-w-full">
              <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/staff/news-list" color="inherit">
                ...
                <div className="flex flex-col min-w-0">
                  <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="text-16 sm:text-20 truncate">
                      {form.title ? form.title : '新增 YS 新聞'}
                    </Typography>
                  </FuseAnimate>
                  <FuseAnimate animation="transition.slideLeftIn" delay={300}>
            ...
            </div>
            {
              selectedNewsId === 'new' ? (
                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                  ...
                  >
                    {isLoading ? <span className="flex justify-center">新增新聞中 <LoadingSpinner width="2em" height="2em" /></span> : '新增新聞'}
                  </Button>
                </FuseAnimate>
              ) : (
                  <div>
                    <FuseAnimate animation="transition.slideRightIn" delay={300}>
                      ...
                      >
                        {isLoadingDelete ? <span className="flex justify-center">刪除新聞中 <LoadingSpinner width="2em" height="2em" /></span> : '刪除新聞'}
                      </Button>
                    </FuseAnimate>
                    <FuseAnimate animation="transition.slideRightIn" delay={300}>
                      <Button
                        ...
                        onClick={handleSaveNews}
                      >
                        {isLoading ? <span className="flex justify-center">更新新聞中 <LoadingSpinner width="2em" height="2em" /></span> : '更新新聞'}
                      </Button>
                    </FuseAnimate>
                  </div>
                )
                ...
                <div className="flex justify-center sm:justify-start flex-wrap">
                  ...
                  {images.map((image, key) => (
                    <div
                      ...
                      key={key}
                    >
                      <Icon className={classes.newsImageFeaturedStar}>star</Icon>
