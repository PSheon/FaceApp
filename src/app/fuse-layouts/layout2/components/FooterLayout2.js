...
function FooterLayout2(props) {
	...
	return (
		<ThemeProvider theme={footerTheme}>
			<AppBar id="fuse-footer" className="relative z-10 py-20 px-12" color="default">
				...
				<div className="px-16 py-24 flex flex-col items-start justify-between sm:py-0 container">
					...
					<div className="flex justify-start items-center w-full md:w-400">
						<div className={clsx(classes.logoImgWrapper, "w-64 p-12 cursor-pointer")}>
							<img alt="google Icon" src={socialLogoConverter('line')} />
						</div>
						<div className={clsx(classes.logoImgWrapper, "w-64 p-12 cursor-pointer")}>
							<img alt="google Icon" src={socialLogoConverter('facebook')} />
						</div>
						<div className={clsx(classes.logoImgWrapper, "w-64 p-12 cursor-pointer")}>
							<img alt="google Icon" src={socialLogoConverter('instgram')} />
						</div>
						<div className={clsx(classes.logoImgWrapper, "w-64 p-12 cursor-pointer")}>
							<img alt="google Icon" src={socialLogoConverter('youtube')} />
						</div>
						<div className={clsx(classes.logoImgWrapper, "w-64 p-12 cursor-pointer")}>
							<img alt="google Icon" src={socialLogoConverter('email')} />
						</div>
					</div>

					<img className="w-256 p-12" src="assets/images/logos/logo.png" alt="logo" />
					...
					<div className="flex flex-col sm:flex-row justify-start items-center w-full">
						...
						<div className="flex flex-col justify-center items-center py-12 sm:py-0 sm:w-2/5">
							...
							<div className="flex justify-around items-center">
								{
									data.map(article => (
										<Typography key={article.id} variant="subtitle2" className="px-8 cursor-pointer" onClick={() => handleOpenDialog(article)}>
											{article.title}
										</Typography>
									))
								}
