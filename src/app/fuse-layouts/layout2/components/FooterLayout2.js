...
function FooterLayout2(props) {
  ...
  return (
    <ThemeProvider theme={footerTheme}>
      <AppBar
        id="fuse-footer"
        className="relative z-10 py-20 px-12"
        color="default"
      >
        ...
        <div className="px-16 py-24 flex flex-col items-start justify-between sm:py-0 container">
          ...
          <div className="flex justify-start items-center w-full md:w-400">
            ...
            >
              <a
                href="https://www.facebook.com/likeYS.TW/"
                target="_blank"
            ...
            >
              <a
                href="https://www.instagram.com/explore/locations/273996678/ys"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            >
              <a
                href="https://www.youtube.com/user/jobnanny"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            >
              <a
                href="mailto:info.youthsalon@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
              >
