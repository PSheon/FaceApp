...
export const SET_REGISTERED_USER_LOADING = '[ADMIN DASHBOARD] SET REGISTERED USER LOADING';
export const SYNC_DASHBOARD_REGISTERED_USER = '[ADMIN DASHBOARD] SYNC ADMIN DASHBOARD REGISTERED USER';
